...
public class RestaurantItemAdapter2 extends RecyclerView.Adapter<RestaurantItemAdapter2.RestaurantItemViewHolder>{
    ...
    public RestaurantItemAdapter2(List<RestaurantDrawerItem> list,Context context) {
        this.list = list;
    ...
    public RestaurantItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurant_drawer_item2,parent,false);
