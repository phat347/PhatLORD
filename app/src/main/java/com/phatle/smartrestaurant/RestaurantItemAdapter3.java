...
public class RestaurantItemAdapter3 extends RecyclerView.Adapter<RestaurantItemAdapter3.RestaurantItemViewHolder>{
    ...
    public interface InterfaceItemClick{
        ...
        void onDirectClick(RestaurantDrawerItem item);
    }
    public void setListener(InterfaceItemClick listener){
        this.mListener = listener;
    }

    public RestaurantItemAdapter3(List<RestaurantDrawerItem> list,Context context) {
        this.list = list;
    ...
    public RestaurantItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurant_drawer_item3,parent,false);
    ...
    public void onBindViewHolder(@NonNull RestaurantItemViewHolder holder, int position) {
        ...
        Picasso.with(context)
                .load(R.drawable.ic_send) //extract as User instance method
                .transform(new CropCircleTransformation())
                .resize(60, 60)
                .into(holder.imgBtnDirect);
...
//        int point = (int)(item.getOverallRating()*10)%10;
        ...
        if(item.isStatus())
        {
            ...
            holder.status2.setText("    •    " + item.getDistance() + "m from you");
        }
        else
        {
...
//        else holder.overallRating.setText(score+"");
    ...
    public class RestaurantItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView dollar1, dollar2, dollar3, dollar4,imgBtnDirect;
        public CardView itemLayout;
        public FrameLayout btnDirect;
        public RestaurantItemViewHolder(View view) {
            ...
            imgBtnDirect = view.findViewById(R.id.img_btn_direct);
        }
    }
}
